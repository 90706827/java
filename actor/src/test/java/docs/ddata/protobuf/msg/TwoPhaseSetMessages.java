...
public final class TwoPhaseSetMessages {
  ...
  public static final class TwoPhaseSet extends
    ...
    public static final akka.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return TwoPhaseSetMessages.internal_static_docs_ddata_TwoPhaseSet_descriptor;
    }

    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return TwoPhaseSetMessages.internal_static_docs_ddata_TwoPhaseSet_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              TwoPhaseSet.class, Builder.class);
    }
     ...
     * <code>repeated string adds = 1;</code>
     */
    public String getAdds(int index) {
    ...
    public static TwoPhaseSet parseFrom(
    ...
    public static TwoPhaseSet parseFrom(byte[] data)
        throws akka.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static TwoPhaseSet parseFrom(
    ...
    public static TwoPhaseSet parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static TwoPhaseSet parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static TwoPhaseSet parseDelimitedFrom(
        java.io.InputStream input,
        akka.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(TwoPhaseSet prototype) {
    ...
    public static final class Builder extends
      ...
      public TwoPhaseSet getDefaultInstanceForType() {
        return TwoPhaseSet.getDefaultInstance();
      }

      public TwoPhaseSet build() {
        TwoPhaseSet result = buildPartial();
      ...
      public TwoPhaseSet buildPartial() {
        TwoPhaseSet result = new TwoPhaseSet(this);
      ...
      public Builder mergeFrom(akka.protobuf.Message other) {
        if (other instanceof TwoPhaseSet) {
          return mergeFrom((TwoPhaseSet)other);
        } else {
      ...
      public Builder mergeFrom(TwoPhaseSet other) {
        if (other == TwoPhaseSet.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          akka.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        TwoPhaseSet parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (akka.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (TwoPhaseSet) e.getUnfinishedMessage();
          throw e;
        } finally {
  ...
  public static final class TwoPhaseSet2 extends
    ...
    public static final akka.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return TwoPhaseSetMessages.internal_static_docs_ddata_TwoPhaseSet2_descriptor;
    }

    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return TwoPhaseSetMessages.internal_static_docs_ddata_TwoPhaseSet2_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              TwoPhaseSet2.class, Builder.class);
    }
    ...
    public static TwoPhaseSet2 parseFrom(
        akka.protobuf.ByteString data)
        throws akka.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static TwoPhaseSet2 parseFrom(byte[] data)
        throws akka.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static TwoPhaseSet2 parseFrom(
    ...
    public static TwoPhaseSet2 parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static TwoPhaseSet2 parseFrom(
    ...
    public static TwoPhaseSet2 parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static TwoPhaseSet2 parseDelimitedFrom(
        java.io.InputStream input,
        akka.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(TwoPhaseSet2 prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
      ...
      public TwoPhaseSet2 getDefaultInstanceForType() {
        return TwoPhaseSet2.getDefaultInstance();
      }

      public TwoPhaseSet2 build() {
        TwoPhaseSet2 result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public TwoPhaseSet2 buildPartial() {
        TwoPhaseSet2 result = new TwoPhaseSet2(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
      ...
      public Builder mergeFrom(akka.protobuf.Message other) {
        if (other instanceof TwoPhaseSet2) {
          return mergeFrom((TwoPhaseSet2)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(TwoPhaseSet2 other) {
        if (other == TwoPhaseSet2.getDefaultInstance()) return this;
        if (other.hasAdds()) {
      ...
      public Builder mergeFrom(
          ...
          akka.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        TwoPhaseSet2 parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (akka.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (TwoPhaseSet2) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
